    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Not Started', 'Не начат'), ('Blocked', 'Заблокирован'), ('Cancelled', 'Отменён'), ('Completed', 'Завершён'), ('In Progress', 'В работе'), ('On Hold', 'В ожидании'), ('Waiting for Resource', 'В ожидании ресурса')], default='', max_length=2000, null=True)),
