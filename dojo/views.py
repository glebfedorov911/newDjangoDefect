...
def custom_bad_request_view(request, exception="Oops... something went wrong."):
    return render(request, "400.html", {"exception": exception})

def custom_not_found_view(request, exception="Well... we can't find what you're looking for."):
