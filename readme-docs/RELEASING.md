...
### Always
- Make sure there's a section in [upgrading.md](https://documentation.synergyvms.com/dev/getting_started/upgrading/) about any specific instructions when upgrading to this new release.
